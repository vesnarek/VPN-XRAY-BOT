...
def os_instruction(os_code: str) -> str:
    ...
    if oc in ("ios", "iphone", "ipad"):
        return (
            ...
            "2) Скопируйте ссылку, нажав на неё \n\n"
    ...
    if oc == "android":
        return (
            "1) Установите приложение v2RayTun из Google Play или по ссылке:\n"
...
def referral_text(my_tg_id: int, bot_username: str) -> str:
    ...
    return (
        "🎁Пригласи друга и получи 15 дней бесплатного пользования\n\n"
        "Как это работает:\n"
        "1) Отправь ему твою ссылку\n"
        "2) Он зарегистрируется и начнет использовать впн\n"
        "3) Тебе на баланс начислится 30₽✅\n\n"
        f"🔗 Твоя ссылка: {link}\n\n"
...
def main_menu_text(fullname: Optional[str], balance_cents: int, active_devices: int) -> str:
    ...
    return (
        ...
        "🙋‍♂️ За каждого приглашённого друга на баланс начисляется 15 дней (30₽) 🙋‍♀️"
    )
